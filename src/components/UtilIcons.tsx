...
export function PlusSmallIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
...
export function MinusSmallIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function Loader(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      width="38"
      height="38"
